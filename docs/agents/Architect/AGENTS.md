...
`docs/agents/Architect/review-checklists.md` 和 `docs/agents/Architect/task-dispatch-templates.md` 这两份文档是你的辅助执行手册。
...
- 工具栏布局目前仍以 `VideoLibraryToolbarController` 为主控基线，但新增模块能力时必须按当前实现核对，不要把这条历史约束误读成“其他工具栏能力永远不能扩展”
