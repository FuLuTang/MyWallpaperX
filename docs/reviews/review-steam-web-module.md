...
> 历史审查材料：主体内容形成于 2026-05-31。文件中的代码量、竞品数据、“完整 API”“没有自动化测试”和同类排名等说法没有按当前代码与门禁持续复核，不能作为现役结论。当前 Web 能力、10+5+34 样本证据和剩余风险见 [Web / Scene 现状评估与演进路线](web-scene-current-state-roadmap-2026-07-19.md)。
