...
本备忘录保留 2026-05-05 的框架结构与协作约定，不作为 Web / Scene 运行能力的现役状态声明。当前实现应以代码和可复现门禁为准；Web / Scene 的最新边界见 [现状评估与演进路线](../reviews/web-scene-current-state-roadmap-2026-07-19.md)。
